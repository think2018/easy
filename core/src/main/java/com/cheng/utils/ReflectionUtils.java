...
public class ReflectionUtils {
	...
	public static Object invokeMethod(final Object object, final String methodName, final Class<?>[] parameterTypes,
		...
		method.setAccessible(true);// 去除方法访问限制
		try {
...
//		Assert.notNull(object, "object不能为空");
	 ...
	 *            要提取的属性名
	 */
	public static List<Object> convertElementPropertyToList(final Collection<Object> collection,
	...
	/** 得到MODEL属性名称 */
	public static String getMethodName(String ColumnName, String type) {
		StringBuffer strb = new StringBuffer();
		String split[] = ColumnName.split("_");
		for (int i = 0; i < split.length; i++) {
			// strb.append(split[i].substring(0, 1).toUpperCase() +
			// split[i].substring(1, split[i].length()));
			strb.append(StringUtils.capitalize(split[i]));
		}
		return type + strb.toString();
	}

	public static String getMethodNameLowCase(String ColumnName) {
		StringBuffer strb = new StringBuffer();
		String split[] = ColumnName.split("_");
		for (int i = 0; i < split.length; i++) {
			if (i == 0)
				...
				strb.append(split[i].substring(0, 1).toUpperCase() + split[i].substring(1, split[i].length()));
		}
	...
	public static Object invokeMethod(Object owner, String methodName, Object[] args) throws NoSuchMethodException,
		...
		// if (haveMethod(owner, methodName)) {
	...
	public static boolean haveMethod(Object argclass, String methodName) {
		// boolean rtn = false;
		Method[] methods = argclass.getClass().getMethods();
